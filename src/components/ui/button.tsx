...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-medium hover:scale-105",
        ...
        hero: "bg-primary text-primary-foreground shadow-medium hover:shadow-large hover:scale-105 hover:-translate-y-0.5",
        whatsapp: "bg-[#25D366] text-white hover:bg-[#128C7E] shadow-medium hover:shadow-large hover:scale-105",
        gold: "bg-gradient-to-r from-gold to-gold-light text-white shadow-medium hover:shadow-large hover:scale-105",
      },
      size: {
